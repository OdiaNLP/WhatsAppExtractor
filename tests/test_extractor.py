...
class TestExtractor:
    ...
    def test_substitute_odia_digits(self):
        ...
        sample_inputs = (
            "COVID-୧୯",
            "୦୧୨୩୪୫୬୭୮୯୦",
            "  121୦୧୨୩  45୪୫୬୭୮୯୦3435 ",
            "୦m"
        )
        exp_outputs = (
            "COVID-19",
            "01234567890",
            "  1210123  4545678903435 ",
            "0m"
        )
        for cnt in range(len(sample_inputs)):
            assert exp_outputs[cnt] == substitute_odia_digits(
                sample_inputs[cnt])
    ...
    def test_extract_patterns(self, get_file_content):
        ...
        exp_response = [
            ...
            {'names': '+91 12345 67890', 'dates': '2/29/20', 'times': '12:15 AM',
                'messages': ' Checking Out: tweet count: 8568', 'counts': '8568'},
            {'names': 'Don MTE2O', 'dates': '2/29/20', 'times': '8:24 AM',
                'messages': ' Don : Checking IN', 'counts': ''},
            {'names': 'Don MTE2O', 'dates': '2/29/20', 'times': '8:45 AM',
                'messages': ' Don: Checking OUT', 'counts': ''}
        ]
